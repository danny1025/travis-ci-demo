...
// travis-ci-demo
#define COCOAPODS_POD_AVAILABLE_travis_ci_demo
#define COCOAPODS_VERSION_MAJOR_travis_ci_demo 0
#define COCOAPODS_VERSION_MINOR_travis_ci_demo 0
#define COCOAPODS_VERSION_PATCH_travis_ci_demo 1
